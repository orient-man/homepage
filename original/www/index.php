...
##############################
   ...
   echo "</p>\n";
	 ...
	 if ($galerieauthor[$galerie]) {
		 echo "<p><span class=\"key\">Author(s): </span>";
		 echo "<span class=\"value\">";
...
#######################
   ...
   */
   ...
   echo "<div id=\"preview\" style=\"width: ${imgsize[0]}px; height: ${imgsize[1]}px\"><img id=\"preview\" ${imgsize[3]} src=\"$file\" alt=\"$snimek\" /></div>\n";
   ...
   if (file_exists("$gallery_dir/$galerie/mq/img-$snimek.jpg") || file_exists("$gallery_dir/$galerie/hq/img-$snimek.jpg")) {
		 ...
		 if (file_exists("$gallery_dir/$galerie/mq/img-$snimek.jpg")) {
				echo "<a href=\"$gallery_dir/$galerie/mq/img-$snimek.jpg\">". __('Medium Quality') . "</a> ";
		 }
		 if (file_exists("$gallery_dir/$galerie/hq/img-$snimek.jpg")) {
				echo "<a href=\"$gallery_dir/$galerie/hq/img-$snimek.jpg\">" . __('High Quality') . "</a>";
		 }
		 echo "</div>\n"; //mqhq
	 }
